...
const EventPage = ({ image, title, info, description }) => {
    ...
    <div className="page-container">
      ...
      <div className="return-btn">
        <img src={returnbtn} alt="return"></img>
      </div>
      <div id="svg-blue">
...
<span className="title2"> {`'${ftitle.year}`}</span>  
          ...
          <div className="page-info">
            <p><span className="info-icon"><img src={location}></img> </span>{info.location}</p>
            <p><span className="info-icon"><img src={date}></img> </span>{info.date}</p>
            <p><span className="info-icon"><img src={website}></img> </span>{info.website}</p>
          </div>
